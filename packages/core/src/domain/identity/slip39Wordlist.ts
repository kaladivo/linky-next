/**
 * The SLIP-39 wordlist (1024 words) as specified by
 * https://github.com/satoshilabs/slips/blob/master/slip-0039.md and shipped
 * by slip39-ts@0.1.13 (the PoC library) — byte-for-byte identical to the
 * list the PoC used. Word order is significant: a word's index is its
 * 10-bit value in the share encoding. NEVER reorder or edit.
 *
 * Exported for the restore UI (#18): prefix suggestions and word-level
 * validation are matched against this list.
 */
export const SLIP39_WORDLIST: ReadonlyArray<string> = [

...
export const en = {
  ...
  syncServersTitle: "Sync servers",
  syncServerStatusConnected: "Connected",
  syncServerStatusChecking: "Checking…",
  syncServerStatusDisconnected: "Disconnected",
  syncServerStatusDisabled: "Disabled",
  syncServersConnectedCount: "{connected}/{total} connected",
  syncServerKeepAtLeastOne: "At least one sync server must remain.",
  syncServerInvalidUrl: "Invalid server URL (expected wss://…)",
  syncServerUpdateFailed: "Couldn't update sync servers.",
  addSyncServer: "Add server",
  syncServerDisable: "Disable",
  syncServerEnable: "Enable",
  syncServersRestartHint: "Restart the app to start syncing via the updated server list.",
  syncServersRestartButton: "Restart now",
  evoluSyncLabel: "Sync",
  evoluSyncOk: "Synced",

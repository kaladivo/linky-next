...
export const cs = {
  ...
  relayUrl: "Relay URL",
  // Sync server settings screen (#53).
  syncServersTitle: "Synchronizační servery",
  syncServerStatusConnected: "Připojeno",
  syncServerStatusChecking: "Kontroluji…",
  syncServerStatusDisconnected: "Odpojeno",
  syncServerStatusDisabled: "Vypnuto",
  syncServersConnectedCount: "{connected}/{total} připojeno",
  syncServerKeepAtLeastOne: "Musí zůstat alespoň jeden synchronizační server.",
  syncServerInvalidUrl: "Neplatná URL serveru (očekávám wss://…)",
  syncServerUpdateFailed: "Synchronizační servery se nepodařilo upravit.",
  addSyncServer: "Přidat server",
  syncServerDisable: "Vypnout",
  syncServerEnable: "Zapnout",
  syncServersRestartHint:
    "Restartujte aplikaci, aby se synchronizovalo přes upravený seznam serverů.",
  syncServersRestartButton: "Restartovat",

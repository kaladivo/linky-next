/**
 * TEMPORARY dev-only seed panel (#26, extended by #28): inserts a few demo
 * contacts, messages and an unknown thread through the real repositories
 * so the Contacts tab (and later the chat work, #29) has data to render.
 * Remove once real add-contact (#27) + messaging (#22/#29) make it
 * redundant.
 *
